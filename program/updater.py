...
async def update_repo(_, message: Message):
    ...
    msg = await message.reply("🔄 `تتم البرمجه بواسطة سورس سقاره......`")
    ...
    if update_avail:
        ...
        return
    await msg.edit(f"تم الترقية بواسطه سورس [-𝐏 𝐴 𝐑 𝑇 𝐘↝ ( ˼سـقـااارهـ˹ )](https://t.me/kyany_el5as)", disable_web_page_preview=True)
